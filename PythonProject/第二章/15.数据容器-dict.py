...
#                 # shopping_cart={"shangpini":{"price":jg,"num":sl},}
    ...
    if choice=="1":
        ...
        while True:
            if name not in student:
                chinese=float(input("请输入语文成绩(0-100)："))
                if 0 >chinese or chinese > 100:
                    print("请输入0-100之间的数")
                    continue
                math=float(input("请输入数学成绩(0-100)："))
                if 0 >math or math > 100:
                    print("请输入0-100之间的数")
                    continue
                english=float(input("请输入英语成绩(0-100)："))
                if 0 >english or english > 100:
                    print("请输入0-100之间的数")
                    continue
